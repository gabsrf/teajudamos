...
<body>
  <header>
    <div class="logo"><img src="logo-teajudamos.png" alt="logo"> </div>
    <nav>
<!-- From Uiverse.io by gharsh11032000 --> 
<div class="menu">
  <div class="item">
...
<div class="menu">
  <div class="item">
    ...
    <div class="submenu">
      <div class="submenu-item">
        <a href="tarefas.php" class="submenu-link"> Matemática </a>
      </div>
      <div class="submenu-item">
        <a href="tarefas.php" class="submenu-link"> Língua Portuguesa </a>
      </div>
      <div class="submenu-item">
        <a href="tarefas.php" class="submenu-link"> História </a>
      </div>
      <div class="submenu-item">
        <a href="tarefas.php" class="submenu-link"> Geografia </a>
      </div>
    </div>
  </div>
</div>
...
<div class="carousel-wrapper">
  <div class="card-3d">
    <div> <p style="color: white; font-size: 30px;">teste</p> </div>
    <div> <p style="color: red; font-size: 30px;">teste</p> </div>
    <div> <p style="color: blue; font-size: 30px;">teste</p> </div>
    <div> <p style="color: green; font-size: 30px;">teste</p></div>
    <div> <p style="color: yellow; font-size: 30px;">teste</p></div>
    <div> <p style="color: grey; font-size: 30px;">teste</p></div>
    <div> <p style="color: black; font-size: 30px;">teste</p></div>
    <div> <p style="color: white; font-size: 30px;">teste</p></div>
    <div></div>
    <div></div>
  </div>
...
<!-- From Uiverse.io by DevPTG --> 
<a href="feedback.php"><div class="chat">
